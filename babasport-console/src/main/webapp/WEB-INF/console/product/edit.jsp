    ...
    <form id="jvForm" action="${ctx}/product/edit.do" method="post" enctype="multipart/form-data">
        ...
        <table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
            ...
            <tr>
                ...
                <input type="checkbox" <c:if test="${product.isNew==1}">checked</c:if> name="isNew" value="1"/>新品
                <input type="checkbox" <c:if test="${product.isCommend==1}">checked</c:if> name="isCommend" value="1"/>推荐
                <input type="checkbox" <c:if test="${product.isHot==1}">checked</c:if> name="isHot" value="1"/>热卖
            </td>
            </tr>
            </tbody>
